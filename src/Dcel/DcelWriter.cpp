...
//        unsigned long size = sizeof(Dcel) + sizeof(Vertex)*dcel.sizeVertex + sizeof(Edge)*dcel.sizeEdges + sizeof(Face)*dcel.vFaces.size();
//
//        // Allocate buffer.
...
//    }
//
//    cout << dcel.vFaces.size() << std::endl;
//    for (auto face : dcel.vFaces)
//    {
//        cout << face << std::endl;
//    }
