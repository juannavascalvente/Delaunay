...
public:
	...
	// Public functions.
	//------------------------------------------------------------------------
	void set( bool first, bool set, bool triangulation, bool delaunay, 		\
												bool voronoi, bool hasGabriel);
	...
	inline void seTriangulationCreated(bool value) \
										{ this->hasTriangulation = value;};
