...
public:
    StatusModel() : hasFirstTime(FIRST_TIME_DEFAULT), hasSet(IS_SET_DEFAULT), hasTriangulation(IS_TRIANGULATION_DEFAULT),
                                                                                hasDelaunay(IS_DELAUNAY_DEFAULT),
                                                                                hasVoronoi(IS_VORONOI_DEFAULT),
                                                                                hasGabriel(IS_GABRIEL_DEFAULT) {};

    StatusModel(bool isFirstTime, bool isSet, bool isTriangulation, bool isDelaunay, bool isVoronoi, bool isGabriel) :
